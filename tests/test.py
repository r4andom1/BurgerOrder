...
menus_table_test = (1, 'Big Juicy Burger Combo', 'Its big... Its juicy...', "Decimal('4.99')")
toppings_table_test = (1, 'Brioche', 'Soft and buttery French-style bread.', "Decimal('1.50')", 1)
topping_type_table_test = [(1, 'Bread'), (2, 'Meat'), (3, 'Topping'), (4, 'Sauce')]
product_type_table_test = [(1, 'burger'), (2, 'drink'), (3, 'side')]
